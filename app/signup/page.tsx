            ...
            <form onSubmit={handleSignup} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-[#1c2750] bg-[#101628] px-4 py-3 text-sm text-white placeholder:text-zinc-600 focus:border-[#CC0000] focus:outline-none"
                />
              </div>
