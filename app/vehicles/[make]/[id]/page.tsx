        ...
        <div className="mx-auto max-w-5xl px-4 py-8">
          ...
          <div className="mt-3 flex items-start justify-between gap-4">
            ...
            <a
              ...
              className="shrink-0 rounded-xl bg-[#CC0000] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#aa0000] transition-colors"
            >
              View Parts
            </a>
          </div>
          ...
          <Section title="Transmission & Drive">
            ...
            <Row label="Transmission Speeds" value={v.transmission_speeds} />
