...
// Usage: node scripts/importers/insert-abarth-vehicles.js scripts/chery_brake_catalogue.csv [--dry-run]
...
if (!csvArg) { console.error('Usage: node scripts/importers/insert-abarth-vehicles.js <file.csv> [--dry-run]'); process.exit(1); }
...
async function main() {
  ...
  console.log(DRY_RUN ? '=== DRY RUN ===' : '=== INSERT ABARTH VEHICLES ===');
